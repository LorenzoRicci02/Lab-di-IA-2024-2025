...
void detectShiTomasiCorners(const cv::Mat& src, cv::Mat& dst, std::vector<cv::Point2f>& corners, int maxCorners = 100, double qualityLevel = 0.01, double minDistance = 10);
